...
const Error3LVL = observer(() => {
    const { state, setError3LVLOpened } = stateSaver;

    return (
        <div
            className={`withdrawal-popup lvl3-required ${
                state.error3LVLOpened ? "withdrawal-successful-active" : ""
            }`}
            style={{ display: state.error3LVLOpened ? "" : "none" }}
            id="butafor__modal"
        >
            <section className="verificationPayment error-occurred">
                ...
                <div className="verificationPayment__right">
                    ...
                    <div className="verificationPayment__des">
                        Oops! It looks like you don't have full access to our
                        exchange service yet. <br />
                        To unlock all features and functionality, you need to
                        obtain <strong>Level 3 verification</strong>. This will
                        only take a few minutes and is required for security and
                        compliance reasons. To start the verification process,
                        please visit your{" "}
                        <Link
                            className="violethrefintext"
                            to="/profile/verification"
                            onClick={() => {
                                setError3LVLOpened(false);
                            }}
                        >
                            KYC page
                        </Link>{" "}
                        and complete the necessary steps. Thank you for choosing
                    ...
                    <div className="verificationPayment__btn-box">
                        ...
                        <div className="verificationPayment__btn-return">
                            <span
                                ...
                                onClick={() => setError3LVLOpened(false)}
                            >
                                NO, MAYBE LATER
                            </span>
                        </div>
