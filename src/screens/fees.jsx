			...
			<div class="page-header">
				<div class="page-header__nav">
					<header class="header">
						<a class="header__logo" href="/">
							<img src="https://bnax.com/static/images/logo.svg" alt="BNAX Global" />
						</a>
						<nav class="header__menu">
							<a class="header__link" href="/exchange/BTC-USDT">
								Exchange
							</a>
							<a class="header__link" href="/markets">
								Market
							</a>
							<a class="header__link" href="/news/blog">
								News
							</a>
							<a class="header__link" href="https://bnax.zendesk.com/">
								Support
							</a>
							<a class="header__link" href="/buycoin">
								Buy crypto
							</a>
							<a class="header__link" href="/rewards">
								Rewards
							</a>
						</nav>
				...
				<div class="page-header__content">
					<div class="page-header__container">
						<h1 class="page-header__heading">Fees</h1>
						<p class="page-header__description">
							Transition fee will be <strong>reduced by 30%</strong> after
							getting Institutional status
						</p>
					</div>
				</div>
			</div>
			<div class="page__container">
				<main class="page__content" role="main">
					<div class="fees-section">
						<div class="fees-section__overflow">
							<table class="fees-section__table">
								<thead class="fees-section__thead">
									<tr class="fees-section__row">
										<td class="fees-section__column" rowspan="2"></td>
										<td class="fees-section__column" colspan="2">
											<span class="fees-section__title">Regular User</span>
											<span class="fees-section__headline">
												0% Fee Discount
											</span>
										</td>
										<td class="fees-section__column" rowspan="2"></td>
										<td class="fees-section__column" colspan="2">
											<span class="fees-section__title">
												Institutional User
											</span>
											<span class="fees-section__headline fees-section__headline_primary">
												30% Fee Discount
											</span>
										</td>
									</tr>
									<tr class="fees-section__row">
										<td class="fees-section__column">Maker</td>
										<td class="fees-section__column">Taker</td>
										<td class="fees-section__column">Maker</td>
										<td class="fees-section__column">Taker</td>
									</tr>
								</thead>
								<tbody class="fees-section__tbody">
									<tr class="fees-section__row">
										<td class="fees-section__column">
											<div class="fees-section__currency">
												<span class="fees-section__currency-name">
													{" "}
													<strong>Lv.1</strong> &lt; 30 BTC
												</span>
											</div>
										</td>
										<td class="fees-section__column">0.075%</td>
										<td class="fees-section__column">0.075%</td>
										<td class="fees-section__column"></td>
										<td class="fees-section__column">0.0525%</td>
										<td class="fees-section__column">0.0525%</td>
									</tr>
									<tr class="fees-section__row">
										<td class="fees-section__column">
											<div class="fees-section__currency">
												<span class="fees-section__currency-name">
													{" "}
													<strong>Lv.2</strong> ≥ 300 BTC
												</span>
											</div>
										</td>
										<td class="fees-section__column">0.065%</td>
										<td class="fees-section__column">0.07%</td>
										<td class="fees-section__column"></td>
										<td class="fees-section__column">0.0455%</td>
										<td class="fees-section__column">0.05%</td>
									</tr>
									<tr class="fees-section__row">
										<td class="fees-section__column">
											<div class="fees-section__currency">
												<span class="fees-section__currency-name">
													{" "}
													<strong>Lv.3</strong> ≥ 900 BTC
												</span>
											</div>
										</td>
										<td class="fees-section__column">0.06%</td>
										<td class="fees-section__column">0.07%</td>
										<td class="fees-section__column"></td>
										<td class="fees-section__column">0.042%</td>
										<td class="fees-section__column">0.05%</td>
									</tr>
									<tr class="fees-section__row">
										<td class="fees-section__column">
											<div class="fees-section__currency">
												<span class="fees-section__currency-name">
													{" "}
													<strong>Lv.4</strong> ≥ 2700 BTC
												</span>
											</div>
										</td>
										<td class="fees-section__column">0.055%</td>
										<td class="fees-section__column">0.065%</td>
										<td class="fees-section__column"></td>
										<td class="fees-section__column">0.0385%</td>
										<td class="fees-section__column">0.0455%</td>
									</tr>
									<tr class="fees-section__row">
										<td class="fees-section__column">
											<div class="fees-section__currency">
												<span class="fees-section__currency-name">
													{" "}
													<strong>Lv.5</strong> ≥ 5000 BTC
												</span>
											</div>
										</td>
										<td class="fees-section__column">0.050%</td>
										<td class="fees-section__column">0.065%</td>
										<td class="fees-section__column"></td>
										<td class="fees-section__column">0.035%</td>
										<td class="fees-section__column">0.0455%</td>
									</tr>
									<tr class="fees-section__row">
										<td class="fees-section__column">
											<div class="fees-section__currency">
												<span class="fees-section__currency-name">
													{" "}
													<strong>Lv.6</strong> ≥ 10000 BTC
												</span>
											</div>
										</td>
										<td class="fees-section__column">0.045%</td>
										<td class="fees-section__column">0.055%</td>
										<td class="fees-section__column"></td>
										<td class="fees-section__column">0.0315%</td>
										<td class="fees-section__column">0.0385%</td>
									</tr>
									<tr class="fees-section__row">
										<td class="fees-section__column">
										...
										<td class="fees-section__column">0.045%</td>
										<td class="fees-section__column"></td>
										<td class="fees-section__column">0.0245%</td>
										<td class="fees-section__column">0.0315%</td>
									</tr>
								</tbody>
							</table>
						</div>
						<p class="fees-section__note">
							The Maker-Taker trading mechanism encourages the continuation of
							price orders and early listings, aims to facilitate digital
							currency trading and maintain price stability.
						</p>
					</div>
				</main>
			</div>
				...
				<div class="footer__container">
					<div class="footer__nav">
						<div class="footer__nav-item">
							<h5 class="footer__nav-title">About us</h5>
							<ul class="footer__nav-list">
								<li class="footer__nav-line">
								...
								<li class="footer__nav-line">
									<a
										class="footer__link"
										href="https://docs.google.com/forms/d/e/92diQLScVTuGtHjiSifjRO6yXIj2T6nFxmyOjDRFfUs6vf78k_iswUw/"
									>
										Careers
									</a>
								</li>
								<li class="footer__nav-line">
									<a class="footer__link" href="mailto:business@bnax.com">
										Business Contacts
									</a>
								</li>
							</ul>
						...
						<div class="footer__nav-item">
							<h5 class="footer__nav-title">Support</h5>
							<ul class="footer__nav-list">
								<li class="footer__nav-line">
									<a
										class="footer__link"
										href="https://bnax.zendesk.com/hc/en-us/requests/new"
									>
										Submit a Ticket
									</a>
								</li>
								<li class="footer__nav-line">
									<a
										class="footer__link"
										href="https://bnax.zendesk.com/hc/en-us"
									>
										Knowledge Base
									</a>
								</li>
						...
						<div class="footer__nav-item">
							...
							<ul class="footer__nav-list">
								...
								<li class="footer__nav-line">
									<a class="footer__link" href="/account/referrals">
										Referrals
									</a>
								</li>
								<li class="footer__nav-line">
									<a class="footer__link" href="https://github.com/bnax">
										API Documentation
									</a>
								</li>
							</ul>
						...
						<div class="footer__nav-item">
							<h5 class="footer__nav-title">Legal</h5>
							<ul class="footer__nav-list">
								<li class="footer__nav-line">
									<a
										class="footer__link"
										href="https://bnax.zendesk.com/hc/en-us/articles/4416479592723-AML-CFT-Policy"
									>
										AML&amp;CFT Policy
									</a>
								</li>
								<li class="footer__nav-line">
									<a
										class="footer__link"
										href="https://bnax.zendesk.com/hc/en-us/sections/4415915397011-SECURITY"
									>
										Security
									</a>
								</li>
								<li class="footer__nav-line">
									<a
										class="footer__link"
										href="https://bnax.zendesk.com/hc/en-us/sections/4415893834387-LEGAL-PRIVACY"
									>
										Legal Statement
									</a>
								</li>
								...
								<li class="footer__nav-line">
									<a
										class="footer__link"
										href="https://bnax.zendesk.com/hc/en-us/articles/4415923719827-Risk-Warning"
									>
										Risk Warning
									</a>
								</li>
						...
						<div class="footer__nav-item">
							<h5 class="footer__nav-title">Community</h5>
							<div class="footer__social">
								<a
									class="footer__social-item"
									href="https://facebook.com/BNAXcom"
								>
									<svg
										width="32"
										height="32"
								...
								<a
									class="footer__social-item"
									href="https://twitter.com/BNAXcom"
								>
									<svg
										width="32"
										height="32"
								...
								<a
									class="footer__social-item"
									href="https://www.reddit.com/r/BNAXadm/"
								>
									<svg
										width="32"
										height="32"
								...
								<a
									class="footer__social-item"
									href="https://github.com/BNAXcom/BNAX"
								>
									<svg
										width="32"
										height="32"
								...
								<a class="footer__social-item" href="https://steemit.com/@bnax">
									<svg
										width="32"
										height="32"
										viewBox="0 0 32 32"
							...
							<div class="footer__languages">
								...
								<div class="nice-select" tabindex="0">
									...
									<ul class="list">
										...
										<li data-value="chinese" class="option">
											简体中文
										</li>
										...
										<li data-value="hindi" class="option">
											हिन्दी
										</li>
										<li data-value="korean" class="option">
											한국어
										</li>
										<li data-value="spanish" class="option">
											Español
										</li>
										<li data-value="turkish" class="option">
											Türkçe
										</li>
										<li data-value="vietnamese" class="option">
											Tiếng Việt
										</li>
										<li data-value="japanese" class="option">
											日本語
										</li>
									</ul>
								</div>
					...
					<div class="footer__info">
						<a class="footer__logo" href="#">
							<img src="https://bnax.com/static/images/logo.svg" alt="BNAX Global" title="" />
						</a>
						<div class="footer__banners">
							<a class="footer__banner">
								<img
									src="https://bnax.com/static/images/banners/bitgo.png"
									alt="BitGo"
									title=""
								/>
							</a>
							<a class="footer__banner">
								<img
									src="https://bnax.com/static/images/banners/comodo-secure.png"
									alt="Comodo Secure"
									title=""
								/>
							</a>
							<a class="footer__banner">
								<img
									src="https://bnax.com/static/images/banners/hsbc-uk.png"
									alt="HSBC UK"
									title=""
								/>
							</a>
						...
						<div class="footer__status">
							<div class="status-bar status-bar_variant_normal">
								<div class="status-bar__content">
									<span class="status-bar__label">Status:</span>
									<p class="status-bar__text">All systems normal</p>
									<span class="status-bar__delay">39 ms</span>
								</div>
							</div>
						</div>
					</div>
					<div class="footer__important">
						<ul class="footer__h-nav">
							<li class="footer__h-nav-item">
								<span class="footer__copyright">
									Copyright © 2021 BNAX Global Ltd. All rights reserved.
								</span>
							</li>
							<li class="footer__h-nav-item">
								<a class="footer__h-nav-link" href="mailto:support@bnax.com">
									support@bnax.com
								</a>
							</li>
							<li class="footer__h-nav-item">
								<a
									class="footer__h-nav-link footer__h-nav-link_primary"
									href="https://bnax.zendesk.com/hc/en-us"
								>
									Support Center
								</a>
						...
						<ul class="footer__h-nav footer__h-nav_without-border">
							<li class="footer__h-nav-item">
								<a
									class="footer__h-nav-link"
									href="https://bnax.zendesk.com/hc/en-us/articles/4415931258771-Terms-of-Use"
								>
									Terms of Service
								</a>
							</li>
							<li class="footer__h-nav-item">
								<a
									class="footer__h-nav-link"
									href="https://bnax.zendesk.com/hc/en-us/articles/4416496832019-Privacy-Policy"
								>
									Privacy Policy
								</a>
							</li>
							<li class="footer__h-nav-item">
								<a
									class="footer__h-nav-link"
									href="https://bnax.zendesk.com/hc/en-us/articles/4416496720531-Cookies-Policy"
								>
									Cookies Policy
								</a>
							</li>
