...
const SignUp = ({ location, history }) => {
    ...
    const { promo } = Object.fromEntries(
    ...
    const submitHandler = (e) => {
        ...
        if (password == passwordRepeat) {
            dispatch(register({ name, email, password, promo }));
        } else {
            if (!toast.isActive(toastId.current)) {
    ...
    return (
        <div
            className="sing-in__body webp other"
                            ...
                            <div className="sing-in__form">
                                ...
                                <label className="checkbox">
                                    <input
                                        ...
                                        defaultChecked
                                    />
                                    <span className="checkbox__style" />I agree
                                    with
                                    <a
                                        style={{
                                            marginLeft: "3px",
                                ...
                                <div className="sing-in__have sing-in__have-bef-top">
