...
!(function () {
        ...
        l = {
            host:
                ...
                window.location.host.match(
                    /tradingview\.com|pyrrosinvestment\.com/i
                )
            ...
            hasCopyright: function (e) {
                var t = document.getElementById(e),
                    o = t && t.parentElement;
                return (
                    !!o && !!o.querySelector(".tradingview-widget-copyright")
                );
            },
            ...
            generateUtmForUrlParams: function (e) {
                var t = {
                    ...
                    utm_medium: l.hasCopyright(e.container)
                        ? "widget_new"
                        : "widget",
                };
                return (
                    e.type &&
                        ((t.utm_campaign = e.type),
            ...
            MediumWidget: function (e) {
                this.id = l.gId();
                const t = l.calculateWidgetHeight(
                    e.height || 400,
                    e.container_id
                );
                let o;
            ...
            IdeasStreamWidget: function (e) {
                console.warn(
                    "We're sorry, the Ideas Stream widget is discontinued"
                );
            },
            IdeaWidget: function () {
                console.warn(
                    "We're sorry, the Idea Preview widget is discontinued"
                );
            },
    ...
    (l.WidgetAbstract.prototype = {
        ...
        addWrapperFrame: function (e) {
            ...
            return (
                (t.id = this.id + "-wrapper"),
                (t.style.cssText =
                    "position: relative;box-sizing: content-box;margin: 0 auto !important;padding: 0 !important;font-family: " +
                    d +
                    ";"),
                (t.style.width = l.WidgetAbstract.prototype.width.call(this)),
                (t.style.height = l.WidgetAbstract.prototype.height.call(this)),
                t.appendChild(e),
                t
            );
        },
        ...
        (l.EventsWidget.prototype = {
            ...
            render: function () {
                ...
                (e.pathname = "/eventswidgetembed/"),
                    ...
                    (this.opLightweightChartstions.type = "events"),
                    l.addUrlParams(e, l.generateUtmForUrlParams(this.options));
        ...
        (l.MediumWidget.prototype = {
            ...
            render: function () {
                ...
                this.options.customer &&
                    (i.pathname += this.options.customer + "/"),
                    this.options.locale &&
                ...
                return (
                    ...
                    this.options.height &&
                        (r.style.height = this.options.height),
        ...
        (l.widget.prototype = {
            ...
            create: function () {
                ...
                this.options.noLogoOverlay ||
                    (t = l.WidgetAbstract.prototype.addWrapperFrame.call(
                        this,
                        t
                    )),
                    c(t, this.options);
                ...
                o && o.parentElement && o.parentElement.removeChild(o),
                    ...
                    l.bindEvent(this.iframe, "load", function () {
                        e.postMessage.get("widgetReady", {}, function () {
                            var t;
                            for (
                                e._ready = !0, t = e._ready_handlers.length;
                                t--;
                    ...
                    e.postMessage.on("openChartInPopup", function (t) {
                        for (
                            var o = l.cloneSimpleObject(e.options),
                                i = ["symbol", "interval"],
                                r = i.length - 1;
                            r >= 0;
                            r--
            ...
            generateUrl: function (e) {
                ...
                n.searchParams.append("hideideas", "1"),
                    n.searchParams.append(
                        "overrides",
                        JSON.stringify(h(e.overrides, {}))
                    ),
                    n.searchParams.append(
                        "enabled_features",
                        JSON.stringify(h(e.enabled_features, []))
                    ),
                    n.searchParams.append(
                        "disabled_features",
                        JSON.stringify(h(e.disabled_features, []))
                    ),
                ...
                return (
                    ...
                    o("range", e.range),
                    i("hidetoptoolbar", e.hide_top_toolbar),
                    i("hidelegend", e.hide_legend),
                    i("hidesidetoolbar", e.hide_side_toolbar, "0"),
                    i("symboledit", e.allow_symbol_change, "0"),
                    i("saveimage", e.save_image, "0"),
                    o("backgroundColor", e.backgroundColor),
                    o("gridColor", e.gridColor),
                    e.watchlist &&
                        e.watchlist.length &&
                        e.watchlist.join &&
                        o("watchlist", e.watchlist.join("")),
                    ...
                    i("hidevolume", e.hide_volume),
                    o("padding", e.padding),
                    i("showpopupbutton", e.show_popup_button),
                    o("padding", e.padding),
                    o("studies_overrides", e.studies_overrides, {}),
                    o("publishsource", e.publish_source),
                    i("enablepublishing", e.enable_publishing),
                    o("venue", e.venue),
        ...
        (l.stream.prototype = {
            ...
            render: function () {
                ...
                l.addUrlParams(e, { locale: this.options.locale }, !0),
                    (this.options.type = "chart"),
                    l.addUrlParams(e, l.generateUtmForUrlParams(this.options));
                const t = document.createElement("iframe");
                return (
                ...
                window.addEventListener("message", function (e) {
                    ...
                    if (t && t.provider && "TradingView" === t.provider)
                        if (((t.source = e.source), "get" === t.type)) {
                            ...
                            i[t.client_id] &&
                                i[t.client_id][t.id] &&
                                (i[t.client_id][t.id].call(t, t.data),
                                delete i[t.client_id][t.id]);
                        else if ("post" === t.type) {
                            if (!r[t.name]) return;
                            r[t.name].forEach(function (e) {
                                "function" == typeof e &&
                                    e.call(t, t.data, function () {});
                            });
                        }
                }),
            function (e, t) {
            ...
            if (i) {
                ...
                if (r) {
                    ...
                    if (n)
                        try {
                            const e = new URL(n);
                            l.addUrlParams(e, l.generateUtmForUrlParams(t)),
                                r.setAttribute("href", e.toString());
                        } catch (e) {
                            console.log(
                                `Cannot update link UTM params, href="${n}"`
                            );
                        }
                }
            }
    ...
    window.TradingView
        ? (function e(t, o) {
              for (var i in o)
                  "object" == typeof o[i] && t.hasOwnProperty(i)
                      ? e(t[i], o[i])
                      : (t[i] = o[i]);
              return t;
